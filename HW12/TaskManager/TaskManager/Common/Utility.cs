    ...
    public static class Utility
    {
        ...
        public static JumpListDisplayStyle JumpListDisplayStyle
        {
            get
            {
                try
                {
                    string strValue = Properties.Settings.Default.ShowTaskListBy;
                ...
                case TaskFlag.Today:
                    {
                        ...
                        return Properties.Resources.Today_Flag;
                    }
                case TaskFlag.Tomorrow:
                    {
                        return Properties.Resources.Tomorrow_Flag;
                    }
                case TaskFlag.ThisWeek:
                    {
                        return Properties.Resources.ThisWeek_Flag;
                    }
                case TaskFlag.NextWeek:
                    {
                        return Properties.Resources.NextWeek_Flag;
                    }
                case TaskFlag.NoDate:
                    {
                        return Properties.Resources.NoDate_Flag;
                    }
        ...
        {
            TaskBar.SetTaskBarIcon(Properties.Resources.Delete_Icon);
            MessageBox.Show(message, caption, MessageBoxButtons.OK, MessageBoxIcon.Error);

            TaskBar.ClearTaskBarIcon();
        }
        ...
        public static DialogResult ShowConfirmationBox(string message, string caption)
        {
            ...
            TaskBar.SetTaskBarIcon(Properties.Resources.Question_Icon);
